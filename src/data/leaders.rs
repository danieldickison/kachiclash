...
use super::{PlayerId, Player, RikishiId, BashoId, BashoRikishi};

pub struct BashoPlayerResults<'a> {
    pub player: ResultPlayer,
    pub total: u8,
    pub days: [Option<u8>; 15],
    pub picks: [Option<&'a BashoRikishi>; 5],
    pub rank: usize,
    pub is_self: bool,
}
...
pub fn fetch_basho_leaders<'a>(db: &Connection, basho_id: BashoId, player_id: Option<PlayerId>, rikishi: &'a HashMap<RikishiId, BashoRikishi>)
    -> Result<Vec<BashoPlayerResults<'a>>, failure::Error> {
